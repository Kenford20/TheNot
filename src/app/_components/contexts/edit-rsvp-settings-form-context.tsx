...
export const EditRsvpSettingsFormProvider = ({
  children,
}: EditRsvpSettingsFormProviderProps) => {
  const [isEditRsvpSettingsFormOpen, setIsEditRsvpSettingsFormOpen] =
  ...
  return (
    <EditRsvpSettingsFormContext.Provider value={isEditRsvpSettingsFormOpen}>
      <EditRsvpSettingsFormUpdateContext.Provider
        value={toggleEditRsvpSettingsForm}
      >
        {children}
      </EditRsvpSettingsFormUpdateContext.Provider>
